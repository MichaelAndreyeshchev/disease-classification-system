        ...
        >
          ...
          <div className={styles.wrapper}>
            ...
            <p className={styles.container__description}>
              ...
              accumsan at tortor at gravida. Nulla at metus massa. Duis
              vestibulum interdum sagittis. Ut at feugiat lorem. Class aptent
              taciti sociosqu ad litora torquent per conubia nostra, per
              inceptos himenaeos. Nam rutrum nec lacus sed malesuada. Nunc
              imperdiet accumsan ipsum quis egestas. Maecenas malesuada luctus
              libero, eget porta lorem tempus id. Praesent vulputate odio quis
              mauris euismod volutpat. Nunc feugiat justo eu magna dictum
              tincidunt. Nam sollicitudin turpis a nulla tempor viverra. Integer
              vehicula ante vulputate, sollicitudin risus et, consequat enim.
              Praesent a ipsum libero. Integer iaculis nibh cursus, rhoncus
              tortor eu, tempus metus. Nam libero justo, commodo porta placerat
              vitae, cursus eget libero. Maecenas ultricies mattis justo in
              euismod. Vivamus eget libero tempus sem scelerisque pellentesque
              ac vitae mauris. Duis sed est ipsum. Cras vulputate porttitor ante
              et varius. Nunc at nunc ac metus commodo elementum. Curabitur
              fermentum ut lectus.
            </p>
            <h3
              className={
            ...
            >
              ...
              soluta eos aliquam officia, quam error in assumenda a ipsa
              delectus cupiditate, maiores accusamus sunt voluptates provident
              nemo? Deleniti sequi sunt optio corporis labore ipsam iste vero
              voluptas, cumque quasi repellat enim neque rerum eum odit mollitia
              illum quibusdam sit aliquam esse natus excepturi! Veritatis eum,
              optio necessitatibus nihil quia sequi cumque cupiditate delectus
              tempora voluptatibus, voluptatem veniam? Eveniet officia suscipit
              ...
              mollitia asperiores saepe eius minus tenetur sequi iste sapiente
              hic quidem nulla fugit distinctio, quaerat optio! Voluptas, ipsa
              rem illo obcaecati ullam accusamus quas corporis enim nemo? Sequi
              earum aut quis et, voluptate voluptatibus tempore dolorem iste,
              quisquam repellat dolorum aliquid itaque eos quas doloribus
              inventore! Quaerat quasi quas, consectetur fugit dicta doloribus
              molestiae porro earum mollitia asperiores? Dolorem esse assumenda
              nulla, officiis unde velit dolore, modi ea mollitia magni
              voluptatem itaque similique aspernatur saepe labore. Dolor
              accusantium temporibus nesciunt natus debitis tempora maiores
              nobis vel, quas omnis quis blanditiis, doloribus alias earum qui
              voluptatem nihil officia facilis?
            </p>
          </div>
        </section>
            ...
            <article className={styles['container__header']}>
              <div>
                ...
                >
                  ...
                  quisque dictum. At odio consequat tellus mauris ullamcorper
                  sed. Nibh non interdum cursus ornare pretium ut.
                </p>
              </div>
            </article>
                  ...
                  width > 1024 ? (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={styles.card__wrapper}>
                          <h3 className={styles.card__subheading}>
                            {data.name}
                          </h3>
                          <AiFillQuestionCircle
                            className={styles.card__icon}
